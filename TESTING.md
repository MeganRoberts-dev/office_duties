...
| Directory | File | Screenshot | Notes |
| --- | --- | --- | --- |
| static | main.js | ![screenshot](documentation/validation/path-to-screenshot.png) | |
...
| --- | --- | --- | --- | --- |
|  | app.py | [PEP8 CI](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/MeganRoberts-dev/office_duties/main/app.py) | ![screenshot](documentation/validation/path-to-screenshot.png) | |
